...
public class DetailDoaSholatSunah extends AppCompatActivity {
    ActionBar toolbar;
    TextView juduldoa;
    TextView doaarab;
    TextView latindoa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_doasholatsunah);

        toolbar = getSupportActionBar();
        juduldoa = findViewById(R.id.detailjudul);
        doaarab = findViewById(R.id.detaildoasholatsunah);
        latindoa = findViewById(R.id.detaillatindoasholatsunah);
        terjemahan = findViewById(R.id.detailterjemahansholatsunah);
