...
public class DetailDoaPilihan extends AppCompatActivity {
    ActionBar toolbar;
    TextView juduldoa;
    TextView doaarab;
    TextView latindoa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_doa_pilihan);

        toolbar = getSupportActionBar();
        juduldoa = findViewById(R.id.detailjudul);
        doaarab = findViewById(R.id.detaildoapilihan);
        latindoa = findViewById(R.id.detaillatindoapilihan);
        terjemahan = findViewById(R.id.detailterjemahanpilihan);
