...
public class RecCardAdapterDoaParaNabi extends RecyclerView.Adapter<RecCardAdapterDoaParaNabi.CardHolder> {
    private Context context;
    private List<StoredDataDoaParaNabi> storedDataList;

    public RecCardAdapterDoaParaNabi(Context context, List<StoredDataDoaParaNabi> storedDataList) {
    ...
    public CardHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.
                ...
                inflate(R.layout.list_doaparanabi, parent, false);
        return new CardHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final RecCardAdapterDoaParaNabi.CardHolder holder, final int position) {
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, DetailDoaParaNabi.class);
